				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<br/>						
							<form class="form-horizontal" action="AddNewState.php" role="form" method="POST">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="sname" placeholder="State Name" class="col-xs-10 col-sm-5" />
										</div>
									</div>
...
if(!empty($_POST))
{
	...
	$result=mysqli_query($con,"INSERT INTO tblState (CountryId,StateName) VALUES ('$c_id','$s_name')") or die("Failed to Query Database".mysql_error());
