							...
							<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
											Results for "Registered Job Postings"
										</div>
										...
										<div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												/*		SELECT Orders.OrderID, Customers.CustomerName, Shippers.ShipperName
														...
														$result=mysqli_query($con,"select * from ((tblJob INNER JOIN tblCompany ON tblJob.CompanyId = tblCompany.CompanyId) INNER JOIN tblJobGroup ON tblJob.JobGroupId = tblJobGroup.JobGroupId)") or die("Failed to Query Database".mysqli_error());
