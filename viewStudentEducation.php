				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">View Student Education</li>
						</ul><!-- /.breadcrumb -->
							...
							<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
											Results for "Registered Student Educations"
										</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php
															...
															$result=mysqli_query($con,"select * from tblEducation INNER JOIN tblCountry ON tblEducation.CountryId = tblCountry.CountryId") or die("Failed to Query Database".mysqli_error());
															//$row=mysql_fetch_array($result);
															  ...
															  if( mysqli_num_rows( $result )==0 ){
																...
																while( $row = mysqli_fetch_assoc( $result ) ){
																  echo "<tr><td>{$row['EducationId']}</td><td>{$row['StudentId']}</td><td>{$row['EducationDegree']}</td><td>{$row['EducationDegreeTitle']}</td><td>{$row['EducationDegreeCGPA']}</td><td>{$row['EducationUniversityName']}</td><td>{$row['CountryName']}</td><td>{$row['EducationCertificationTitle']}</td><td>{$row['EducationCertificationBody']}</td>
																 <td>
