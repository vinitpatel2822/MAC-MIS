				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<br/>						
							<form class="form-horizontal" action="AddNewCity.php" role="form" id="form1" method="POST">
									...
									<div class="form-group">
										...
										<div class="col-sm-3 widget-body">
															...
															print"<select class=\"form-control\" name=\"cmbCountry\" onchange=\"javascript:__doPostBack();\" id=\"cid\">";
														...
														<!--	<select class="form-control" name="cid" id="form-field-select-1" onchange="GetSelectedTextValue(this)">
															</select> -->
										</div>
									</div>
										...
										<div class="col-sm-3 widget-body">
														...
														<?php 
																...
																if(isset($_REQUEST['cmbCountry']))
																{
																	...
																	print"<select class=form-control name=cmbState id=sid selectedValue=". $_REQUEST['cmbCountry'] .">";
																	echo "<option value='0'>Select State";
																	while ($row = $data->fetch_assoc())
																	{
																		$sid=$row['StateId'];
																		$sname=$row['StateName'];
																		echo "<option value='$sid'>$sname";
																	}
																	echo "</select>";
																}
																else
															...
															?>
														<!--	<select class="form-control" name="sid" id="form-field-select-1">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="cname" placeholder="City Name" class="col-xs-10 col-sm-5" />
										</div>
									</div>
...
try{
	...
	$result=mysqli_query($con,"INSERT INTO tblCity (StateId,CountryId,CityName) VALUES ('$s_id','$c_id','$c_name')") or die("Failed to Query Database".mysql_error($con));
