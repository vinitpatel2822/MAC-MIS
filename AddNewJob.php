				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<br/>						
							<form class="form-horizontal" action="AddNewJob.php" role="form" method="POST">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="position" placeholder="Position" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea id="form-field-1" name="desc" class="col-xs-10 col-sm-5">
											</textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea id="form-field-1" name="resp" class="col-xs-10 col-sm-5">
											</textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea id="form-field-1" name="req" class="col-xs-10 col-sm-5">
											</textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="sal" placeholder="Salary" class="col-xs-10 col-sm-5" />
										</div>
									</div>
...
if(!empty($_POST))
{
	$c_Id=$_POST['cId'];
	$j_Id=$_POST['jId'];
	$int_Type=$_POST['intType'];
	$j_position=$_POST['position'];
	$j_desc=$_POST['desc'];
	$j_resp=$_POST['resp'];
	$j_req=$_POST['req'];
	$j_sal=$_POST['sal'];
	$j_status=$_POST['status'];
	...
	$result=mysqli_query($con,"INSERT INTO tblJob (CompanyId,JobGroupId,InternshipType,JobPosition,JobDescription,JobResponsibilities,JobRequirements,JobSalary,JobStatus) VALUES ('$c_Id','$j_Id','$int_Type','$j_position','$j_desc','$j_resp','$j_req','$j_sal','$j_status')") or die("Failed to Query Database".mysqli_error());
