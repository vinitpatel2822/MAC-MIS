			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Reports</li>
								<li class="active">Employer from specific City</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<form action="rptEmployerCity.php" class="form-horizontal" role="form" method="POST">
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Employer City </label>

										<div class="col-sm-3 widget-body">
											
															<select class="form-control" name="city" id="form-field-select-1">
																<?php
...
<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												/*		SELECT Orders.OrderID, Customers.CustomerName, Shippers.ShipperName
														...
														$result=mysqli_query($con,"select * from ((tblJob INNER JOIN tblCompany ON tblJob.CompanyId = tblCompany.CompanyId) INNER JOIN tblJobGroup ON tblJob.JobGroupId = tblJobGroup.JobGroupId) where tblCompany.CityId = '$c_ity'") or die("Failed to Query Database".mysqli_error());
