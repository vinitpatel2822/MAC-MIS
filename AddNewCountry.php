				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<br/>						
							<form class="form-horizontal" action="AddNewCountry.php" role="form" method="POST">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Country Name </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="cname" placeholder="Country Nmae" class="col-xs-10 col-sm-5" />
										</div>
									</div>
...
if(!empty($_POST))
{
	...
	$result=mysqli_query($con,"INSERT INTO tblCountry (CountryName) VALUES ('$c_name')") or die("Failed to Query Database".mysql_error());
