				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Add Job Group</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<br/>						
							<form class="form-horizontal" action="AddJobGroup.php" role="form" method="POST">
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Job Group </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="Jgroup" placeholder="Job Group" class="col-xs-10 col-sm-5" />
										</div>
									</div>
...
try{	
	...
	$result=mysqli_query($con,"INSERT INTO tblJobGroup (JobGroupName) VALUES ('$J_group')") or die("Failed to Query Database".mysql_error());
