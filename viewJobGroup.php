				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">View Job Group</li>
						</ul><!-- /.breadcrumb -->
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php
														...
														$result=mysqli_query($con,"select * from tblJobGroup") or die("Failed to Query Database".mysqli_error());
														//$row=mysql_fetch_array($result);
																...
																while( $row = mysqli_fetch_assoc( $result ) ){
																  echo "<tr><td>{$row['JobGroupId']}</td><td>{$row['JobGroupName']}</td>
																 <td>
