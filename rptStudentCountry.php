				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Student From Specific Country</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<form action="rptStudentCountry.php" class="form-horizontal" role="form" method="POST">
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Student Country </label>
...
<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												/*		SELECT Orders.OrderID, Customers.CustomerName, Shippers.ShipperName
														...
														$result=mysqli_query($con,"select * from ((tblStudent INNER JOIN tblCountry ON tblStudent.CountryId = tblCountry.CountryId) INNER JOIN tblSemester ON tblStudent.SemesterId = tblSemester.SemesterId) where tblStudent.CountryId = '$c_ountry'") or die("Failed to Query Database".mysqli_error());
