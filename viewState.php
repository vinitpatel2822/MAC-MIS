										...
										<div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												/*		SELECT Orders.OrderID, Customers.CustomerName, Shippers.ShipperName
														...
														$result=mysqli_query($con,"select * from tblState INNER JOIN tblCountry ON tblState.CountryId = tblCountry.CountryId") or die("Failed to Query Database".mysqli_error());
														//$row=mysql_fetch_array($result);
																...
																while( $row = mysqli_fetch_assoc( $result ) ){
																  echo "<tr><td>{$row['StateId']}</td><td>{$row['StateName']}</td><td>{$row['CountryName']}</td>
																 <td>
