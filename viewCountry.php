							...
							<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
											Results for "Registered Countries"
										</div>
<br/>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php
														...
														$result=mysqli_query($con,"select * from tblCountry") or die("Failed to Query Database".mysqli_error());
														//$row=mysql_fetch_array($result);
																...
																while( $row = mysqli_fetch_assoc( $result ) ){
																  echo "<tr><td>{$row['CountryId']}</td><td>{$row['CountryName']}</td>
																 <td>
